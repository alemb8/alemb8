...
int main(void)
{
    ...
    while (card < 0);  //Card Number while be greather than 0
    ...
    card7 = ((card % 10000000000000) / 10000000000000) * 2;
    card8 = ((card % 1000000000000000) / 1000000000000000) * 2;
    ...
    //Diference between VIsa, Master and Amex
    while (card > 0)
    {
        card = card / 10;
        length++;
    ...
    if (length == 13 || length == 14 || length == 15 || length == 16)
    {
        ...
        //Identify if a card is Mastercard
        while (master >= 1000000000000000)
        {
